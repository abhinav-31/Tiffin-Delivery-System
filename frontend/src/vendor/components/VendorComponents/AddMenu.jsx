...
import { addMenu } from '../../../services/vendor_api'; // Adjust the path as needed
...
const AddMenu = () => {
    ...
    // Example vendorId; replace with actual logic if needed
    const vendorId = 1;
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            toast.error(`An error occurred while submitting the form: ${error.response ? error.response.data.message : error.message}`);
        }
    };
