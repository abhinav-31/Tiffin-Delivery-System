...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	// @Query("SELECT o FROM Order o JOIN FETCH o.customer c JOIN FETCH c.addresses
	...
	// o.vendor " + "JOIN FETCH o.deliveryBoy "
	// + "JOIN FETCH o.deliveryAddress " + "WHERE o.vendor.id = :vendorId AND
	// o.status = :status")
	// List<Order> findByVendorAndStatusWithFetch(@Param("vendorId") Long vendorId,
